import img1 from './images/mother-baby-sq-jpg.jpg';
import img2 from './images/plant-sq-jpg.jpg';
import img3 from './images/rsz_oct_food_medicine-media.jpg';
import img4 from './images/oatmeal-sq-jpg.jpg';
import img5 from './images/aloe-vera-sq-jpg.jpg';
...
},
{
    ...
    content: `<p> Medicinal but misunderstood, goldenrod can be used as an herbal remedy to combat the symptoms of allergies.
              ...
              Outside the realm of allergies, goldenrod is a supporter of the urinary tract, helping to dissolve kidney stones (2). It also acts as a natural plant dye, turning natural wool a vibrant yellow (8).<br><br/>

              <p>Less medicinally, and more aesthetically, I’ve taken to hanging golden throughout our house, over doors, and tucked into woven baskets in every corner. Seeing the bright yellow flowers contrast the dark green leaves makes even the dullest spaces look alive and happy!<br><br/>

              <p>This is the power of goldenrod, and I suppose of most healing herbs, while they work to physically nurture the body, the process of collecting, transforming, and using them nurtures the soul.<br><br/>`,

},
{
    image: img3,
    title :   `Food Medicine: 5 Autumn Healers`,
    subtitle: `Stay healthy with herbal remedies, a nourishing diet, and a chemical-free home.`,
...
{
    image: img4,
    title :   `Cleansing Grains Recipe`,
    subtitle: `Stay healthy with herbal remedies, a nourishing diet, and a chemical-free home.`,
    content:  `<p>Find out how to use the everyday grains in your kitchen to easily craft an all natural cleanser.
              Oatmeal, cornmeal, and wheat germ all make excellent skin scrubs on their own, so why not combine the three to create a multipurpose cleansing grain mixture that can be used all over your face and body? Keep a jar of these cleansing grains in your bathroom, and add a small amount of the mixture to your favorite cleanser to give it extra cleaning power and help remove dead skin cells. Yield: 2 ounces.<br><br/>
               ...
               <h3> Directions</h3>
                <p>Mix all three ingredients together, and store in an airtight container. To use cleansing grains for your face, combine 1 or 2 teaspoons of the mixture with equal parts water or cleanser to create a paste. (You’ll need about 1/2 cup for your whole body.) Massage this paste gently into your skin. Rinse well with warm water, and pat dry.<br><br/>`
},
{
    image: img5,
     title :   `Olive Oil Cleanser Recipe`,
     subtitle: `Stay healthy with herbal remedies, a nourishing diet, and a chemical-free home.`, 
     content:  `<p>Check out this quick and easy recipe for an olive oil cleanser, It's the perfect addition your all-natural skin care routine.      
               In ancient times, when clean water was scarce, olive oil was used to clean the body and protect the skin. It penetrates effectively to cleanse and moisturize. In the evening, after using this cleansing lotion, follow up with an application of more oil massaged into your skin. Yield: 6 ounces.<br><br/>
              ...
              <h3>Directions<h3>
              <p>Mix all ingredients together in a blender or by hand, until smooth and creamy. Pour olive oil cleanser into a clean container with a tight-fitting lid. To use, put a small amount of the cleansing lotion in the palm of your hand and massage into your skin. Rinse well with warm water, and pat dry.<br><br/>`,
    date: `Nov 15, 2020`,   
    comments: ["this is a comment" , "this is another comment"]
 }
];
